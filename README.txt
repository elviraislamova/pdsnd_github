...
Bike Share Data
     ...
     In this project, the data is provided byÊMotivate, a bike share system provider for many major cities in the United States, to uncover bike share usage patterns. One will explore the usage between three large cities: Chicago, New York City, and Washington, DC.
The Datasets
